...
func main() {
	...
	ring.DelNode("10.111.1.6:8080", 1)
	ring.Bake()
...
func (h *hashRing) DelNode(name string,s int){
	...
	for i := 1; i <= tSpots; i++ {
		...
		j := sort.Search(h.length, func(i int) bool { return h.ticks[i].hash >= v })
