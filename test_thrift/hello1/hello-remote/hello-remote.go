...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  Pair helloPair()")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := hello1.NewHelloClientFactory(trans, protocolFactory)
	...
	case "helloPair":
		if flag.NArg()-1 != 0 {
			fmt.Fprintln(os.Stderr, "HelloPair requires 0 args")
			flag.Usage()
		}
		fmt.Print(client.HelloPair())
		fmt.Print("\n")
		break
	case "":
		Usage()
